namespace Resxtractor.Helpers
{
    ...
    public class ResxHelper
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResxHelper"/> class.
        /// </summary>
        /// <param name="resxFile">The resxFile<see cref="string"/>.</param>
        /// <param name="replace">The replaceMode<see cref="bool"/>.</param>
        public ResxHelper(string resxFile, bool replace = true)
        {
            ResxFile = resxFile;
            Replace = replace;
        }
        ...
        public void UpdateResxFile(Dictionary<string, string> resource = null)
        {
            ...
            if (!Replace) targetResxFile = targetResxFile.Replace(Path.GetExtension(targetResxFile), $".auto{Path.GetExtension(targetResxFile)}");
